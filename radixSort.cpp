...
public:
    ...
    void collectFromDigitQueue(queue<int> *digitQueue, vector<int> &vector);
...
void RadixSort::collectFromDigitQueue(queue<int> *digitQueue, vector<int> &vector)
{
...
void RadixSort::radixSort(vector<int> & vector, int maxDigits)
{
    ...
    for (int i = 0; i < maxDigits; ++i)
    {
        ...
        collectFromDigitQueue(digitQueue, vector);
        power *= 10;
    }
}
